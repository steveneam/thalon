...
**s57 opener: founder one-word confirm on the four named lanes, then execute** — lead remints → Sprig & Barrow port; lanes run the wave-1 taste pass + the boards/calendar survey. Everything else is pre-approved on the board.
