...
- [2026-07-18] **WORKSPACE DESIGN CHECKPOINT (gates Phase I):** all SEVEN Phase D designs are done in claude-design (project "Thalon workspace — Phase D"): Workspace Spine · Content Calendar · Calendar Week · Leads Board · Intel Dossier · Create Handoff · Approve Consent — each carries its decision-annotation table; repo ledger = docs/research/workspace-phase-d-designs.md. Checkpoint also decides: manifest model/credits fields · headlamp.webp cleanup · recurrence (Q9) + undo-after-terminal (Q4) flags
