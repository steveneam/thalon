...
- Short: aim for 50–90 words of body, never more than 110 (short first-touch
  emails with a single ask outperform long ones decisively). One idea, one soft call to action — the preferred
...
- The subject line is honest and concrete (recipients read it as part of the message —
  it is judged like the body). 6–10 words, the concrete value in the FIRST few words
  (mobile clients truncate). No clickbait, no fake "Re:".
- The FIRST sentence is about THEM — their situation, in words close to the brief's.
  Banned openers (they read as automation): "hope this finds you well", congratulations
  on funding/promotion/growth, "I noticed [company] is growing", weather/weekend
  small-talk, or anything about us before them.
